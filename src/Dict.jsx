export const dict = {
  ...
  'avarage' : 'میانگین جلسات ادوبی',
  'number_of_meetings': 'تعداد جلسات ادوبی',
  'duration': 'طول جلسه',
  'kian': 'کیان',
  'attendances': 'حاضرین',
  'attendance_duration':'دقایق حضور',
  'utid':'شناسه',
  'attendance_percentage': 'درصد حضور',
  'faculties': 'دانشکده ها',
  'total_assets': 'مجموع فعالیت',
  'id': 'شناسه',
  'courses_most_quiz':'دروس با بیشترین امتحانات',
  'courses_most_resource':'دروس با بیشترین منابع',
  'courses_most_assignment':'دروس با بیشترین تمرین ها',
  'teacher': 'مدرس',
  'courses_most_occ': 'دروس با بیشترین تعداد جلسات ادوبی',
  'courses_most_ocd': 'دروس با بیشترین زمان جلسات ادوبی',
  'courses_most_activity':'دروس با بیشترین مجموع فعالیت',
  'bb_meetings': 'جلسات اتاق تعامل',
  'adobe_meetings': 'جلسات ادوبی',
